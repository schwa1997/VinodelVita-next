...
// report api
export async function getAllReportsAsAdmin(
  orderBy: string,
  vineyard: string,
  page: number
) {
  ...
  const response = await commonRequest.get("/reports?orderBy=createdAt", {
    headers,
  });
  return response.data;
}
...
export async function paginateReports(
  ...
  const response = await commonRequest.get(
    `/reports/paginate?orderBy=createdAt&page=${page}`,
    {
      headers,
    }
  );
...
export async function postReport(
  ...
  if (!title || !disease || !description) {
    throw new Error(
      "Missing required fields. Please provide all required data."
    );
  }
...
export async function getAllVineyardsAsAgronomists() {
  ...
  try {
    const response = await commonRequest.get("/vineyards/listByAdmin", {
      headers,
    }); // Make the HTTP GET request to fetch areas.
    return response.data; // Return the data received from the server (array of areas).
  } catch (error) {
...
export async function getAllVineyardsByUserID() {
  ...
  try {
    const response = await commonRequest.get("/vineyards/listVineyards", {
      headers,
    }); // Make the HTTP GET request to fetch areas.
    return response.data; // Return the data received from the server (array of areas).
  } catch (error) {
...
export async function getVineyardByAreaID(id: string) {
  ...
  try {
    const response = await commonRequest.get(`/vineyards/area/${id}`, {
      headers,
    }); // Make the HTTP GET request to fetch areas.
    return response.data; // Return the data received from the server (array of areas).
  } catch (error) {
...
export async function getInterventionsAsAgronomists() {
  ...
  try {
    const response = await commonRequest.get("interventions/listAll", {
      headers,
    }); // Make the HTTP GET request to fetch areas.
    return response.data; // Return the data received from the server (array of areas).
  } catch (error) {
